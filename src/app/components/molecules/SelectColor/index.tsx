...
const SelectColor = () => {
  ...
  useEffect(() => {
    const handleSelectMenu = (e: ChangeEvent<HTMLSelectElement>) => {
    ...
    <div className="relative w-full  text-base">
      ...
      {state ? (
        <div className="relative w-full">
          <ul
            className="absolute z-10 w-full mt-3 overflow-y-auto bg-white border rounded-md shadow-sm max-h-64"
            role="listbox"
          >
